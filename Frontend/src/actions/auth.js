...
// export const signup = (email, username, first_name, password) => async dispatch => {
    // const config = {
        // headers: {
            // 'Content-Type': 'application/json'
        // }
    ...
    // const body = JSON.stringify({ email, username, first_name, password });

    // try {
        // const res = await axiosInstance.post(`user/create/`, body, config);
...
// export const logout = () => async dispatch => {
    ...
    // try {
        // const res = await axiosInstance.post(`user/logout/blacklist/`)
